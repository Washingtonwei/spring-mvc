...
public class LoginAspect {
    ...
    @Before("mwsu.springframework.services.security.LoginAspect.doAuthenticate() && args(authentication)")
    ...
    @AfterReturning(value="mwsu.springframework.services.security.LoginAspect.doAuthenticate()", returning="authentication")
    ...
    @AfterThrowing("mwsu.springframework.services.security.LoginAspect.doAuthenticate() && args(authentication)")
